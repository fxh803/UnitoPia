...
// 转盘配置
const wheelRadius = 80 // 转盘半径（与主画布一样）
    ...
    <div v-if="showWheel" class="wheel-overlay" @click="closeWheel">
        <div class="wheel-container" :style="wheelPosition" @click.stop>
            ...
            <div class="wheel-content">
                ...
                <!-- 层级上移按钮 -->
                <button v-if="showLayerUpBtn" class="wheel-btn layer-up-wheel-btn"
                ...
                <!-- 层级下移按钮 -->
                <button v-if="showLayerDownBtn" class="wheel-btn layer-down-wheel-btn"
